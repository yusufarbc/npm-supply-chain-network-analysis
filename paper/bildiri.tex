...
\label{fig:impact}
\end{figure}
Simülasyon sonuçları BRS modelini desteklemektedir. Şekil \ref{fig:impact}'da, yüksek BRS skorlu paketlerin çıkarılmasının LCC boyutunda düşüşe neden olduğu görülmektedir. BRS skoru ile kaskad etki arasındaki korelasyon (Şekil \ref{fig:cascade}), metriğin risk öngörüsündeki başarısını göstermektedir.
